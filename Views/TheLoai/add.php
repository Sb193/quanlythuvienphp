            ...
            <form action="" method="post">
                <div class="form-horizontal">
                    <div class="card-header">
                        <h4 class="font-weight-bold text-primary d-flex justify-content-center align-items-center m-0">Biểu mẫu thêm thể loại</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="TenTL" id="" class="form-control">
